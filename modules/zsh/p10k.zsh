# Generated by Powerlevel10k configuration wizard on 2024-02-18 at 14:59 GMT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 33069.
# Wizard options: awesome-fontconfig + powerline, small icons, classic, unicode, light,
# vertical separators, sharp heads, flat tails, 1 line, sparse, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    res="%3F${VCS_STATUS_LOCAL_BRANCH}"
